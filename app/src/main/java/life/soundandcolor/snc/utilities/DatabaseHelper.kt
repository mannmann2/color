...
//        db.execSQL("create table $TABLE_NAME3 (username TEXT, name TEXT, id TEXT, url TEXT, album TEXT, img TEXT, artist TEXT, duration TEXT, " +
...
//        catch (e: SQLiteConstraintException) {}
    ...
    fun get_current(): Cursor {
        val db = this.writableDatabase
        return db.rawQuery("select $COL_1, $COL_2 from $TABLE_NAME2;", null)
    }
